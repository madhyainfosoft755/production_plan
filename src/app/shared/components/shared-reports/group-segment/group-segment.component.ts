...
@Component({
  selector: 'app-group-segment',
  templateUrl: './group-segment.component.html',
  styleUrl: './group-segment.component.scss'
})
export class GroupSegmentComponent  implements OnInit {
  breadcrumbItems: any[];
  // data: any;
