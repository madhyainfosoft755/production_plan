        ...
        this.model = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: 'Group Target', icon: 'pi pi-fw pi-id-card', routerLink: [`/${this.user.role.toLowerCase()}/reports/group-target`] },
                    { label: 'Group Details', icon: 'pi pi-fw pi-id-card', routerLink: [`/${this.user.role.toLowerCase()}/reports/group-details`] },
                    { label: 'Finish Wise Planning', icon: 'pi pi-fw pi-id-card', routerLink: [`/${this.user.role.toLowerCase()}/reports/finish-wise-planning`] },
